...
# probe -create -shm chip.accelerator.H_matrix_00 -waveform
...
# probe -create -shm chip.accelerator.adder.genblk1[3].mca_single_as.H_matrix_00 -waveform
# probe -create -shm chip.accelerator.adder.genblk1[3].mca_single_as.H_matrix_01 -waveform
...
# probe -create -shm chip.accelerator.adder.genblk1[0].mca_single_as.genblk2.stage_1_generate[0].mca_adder_stage_1.S_values -waveform
...
# probe -create -shm chip.accelerator.adder.genblk1[0].mca_single_as.genblk2.stage_1_generate[0].mca_adder_stage_1.operands_00 -waveform
...
probe -create -shm chip.accelerator.adder.genblk1[0].mca_single_as.mca_adder_final.imm_res_reg -waveform
probe -create -shm chip.accelerator.adder.genblk1[0].mca_single_as.mca_adder_final.res_reg -waveform
probe -create -shm chip.accelerator.adder.genblk1[0].mca_single_as.mca_adder_final.counter -waveform
